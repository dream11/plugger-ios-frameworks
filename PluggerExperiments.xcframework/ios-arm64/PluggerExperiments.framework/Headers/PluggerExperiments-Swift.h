...
#ifndef PLUGGEREXPERIMENTS_SWIFT_H
#define PLUGGEREXPERIMENTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PluggerExperiments",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC18PluggerExperiments10Experiment")
...
@interface ExperimentConfig : NSObject <Config>
...
SWIFT_CLASS("_TtC18PluggerExperiments18ExperimentResponse")
@interface ExperimentResponse : NSObject
@end


SWIFT_CLASS("_TtC18PluggerExperiments23ExperimentResponseError")
@interface ExperimentResponseError : NSObject
@end


SWIFT_CLASS("_TtC18PluggerExperiments18ExperimentSnapshot")
@interface ExperimentSnapshot : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP18PluggerExperiments19ExperimentsDelegate_")
@protocol ExperimentsDelegate
- (void)onSuccess;
- (void)onFailureWithError:(NSString * _Nonnull)error;
@end


SWIFT_CLASS("_TtC18PluggerExperiments15PlugExperiments")
@interface PlugExperiments : NSObject <Initializable>
...
@interface PlugExperiments (SWIFT_EXTENSION(PluggerExperiments)) <Configurable>
...
SWIFT_CLASS("_TtC18PluggerExperiments8Variable")
