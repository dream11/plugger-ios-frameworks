...
SWIFT_CLASS("_TtC11PluggerCore21CustomSessionDelegate")
@interface CustomSessionDelegate : NSObject <NSURLSessionTaskDelegate>
...
typedef SWIFT_ENUM(NSInteger, PluginList, open) {
  ...
  PluginListEvents = 3,
  PluginListAuthProvider = 4,
  PluginListAuthConsumer = 5,
};
