...
#ifndef PLUGGERFEATUREFLAGS_SWIFT_H
#define PLUGGERFEATUREFLAGS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PluggerFeatureFlags",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC19PluggerFeatureFlags11FeatureFlag")
...
SWIFT_CLASS("_TtC19PluggerFeatureFlags19FeatureFlagResponse")
@interface FeatureFlagResponse : NSObject
@end
...
@interface FeatureFlagsConfig : NSObject <Config>
...
SWIFT_PROTOCOL("_TtP19PluggerFeatureFlags20FeatureFlagsDelegate_")
@protocol FeatureFlagsDelegate
- (void)onSuccess;
- (void)onFailureWithError:(NSString * _Nonnull)error;
@end


SWIFT_CLASS("_TtC19PluggerFeatureFlags16PlugFeatureFlags")
@interface PlugFeatureFlags : NSObject <Initializable>
